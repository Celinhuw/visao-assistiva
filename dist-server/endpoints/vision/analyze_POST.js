import { schema } from "./analyze_POST.schema.js";
...
export async function handle(request) {
    try {
        ...
        let promptText = "Você é um assistente visual para pessoas cegas. Descreva o que você vê na imagem de forma concisa (máximo 2 frases). Foque em: obstáculos, pessoas, objetos importantes, texto visível e perigos.";
        if (data.mode === "smart") {
            promptText +=
        ...
        const isNoChange = data.mode === "smart" &&
